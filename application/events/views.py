...
@app.route("/events/duplicate/<id>", methods=["POST"])
@login_required
...
def edit_events(id):
    ...
    return render_template("events/edit.html", events = e,
        form = EventForm(day=e_date, name=e.name, time=e.time, info=e.info))
